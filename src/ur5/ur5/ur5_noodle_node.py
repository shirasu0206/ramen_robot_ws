...
class UR5NoodleNode(Node):
    ...
    def execute_noodle_task(self):
       ...
       #scratching
        ...
        +"movel([0.111047934,-0.817861287,2.243271687,-5.186769471,-1.671152758,3.115238181], a=3.00, v=1.50)" + "\n"
        +"movel([0.111047934,-0.817861287,2.379407369,-5.186769471,-1.671152758,3.115238181], a=3.00, v=1.50)" + "\n"
        +"movej([0.217642558,-1.018225086,2.137679268,-5.11154578,-1.708677338,3.042457952], a=0.500, v=0.1)" + "\n"#麺茹で終わり
