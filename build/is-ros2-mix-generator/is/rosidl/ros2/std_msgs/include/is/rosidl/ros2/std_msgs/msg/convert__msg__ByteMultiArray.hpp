...
#ifndef _IS_SH_ROS2_ROSIDL__ROS2__STD_MSGS__MSG__CONVERT__MSG__BYTE_MULTI_ARRAY_HPP_
#define _IS_SH_ROS2_ROSIDL__ROS2__STD_MSGS__MSG__CONVERT__MSG__BYTE_MULTI_ARRAY_HPP_
...
namespace sh {
namespace ros2 {
namespace convert__std_msgs__msg__byte_multi_array {

using Ros2_Msg = std_msgs::msg::ByteMultiArray;
const std::string g_msg_name = "std_msgs/ByteMultiArray";
...
inline const eprosima::xtypes::StructType& type()
{
    ...
    if (!context.success)
    {
        throw std::runtime_error("Failed while parsing type std_msgs::msg::ByteMultiArray");
    }
    static eprosima::xtypes::StructType type(context.module().structure("std_msgs::msg::ByteMultiArray"));
...
namespace utils {
template<>
struct Convert<sh::ros2::convert__std_msgs__msg__byte_multi_array::Ros2_Msg>
    : MessageConvert<
     sh::ros2::convert__std_msgs__msg__byte_multi_array::Ros2_Msg,
    &sh::ros2::convert__std_msgs__msg__byte_multi_array::convert_to_ros2,
    &sh::ros2::convert__std_msgs__msg__byte_multi_array::convert_to_xtype
    > { };
...
#endif // _IS_SH_ROS2_ROSIDL__ROS2__STD_MSGS__MSG__CONVERT__MSG__BYTE_MULTI_ARRAY_HPP_
