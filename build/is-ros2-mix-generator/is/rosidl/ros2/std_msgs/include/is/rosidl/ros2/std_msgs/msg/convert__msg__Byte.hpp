...
#ifndef _IS_SH_ROS2_ROSIDL__ROS2__STD_MSGS__MSG__CONVERT__MSG__BYTE_HPP_
#define _IS_SH_ROS2_ROSIDL__ROS2__STD_MSGS__MSG__CONVERT__MSG__BYTE_HPP_
...
namespace sh {
namespace ros2 {
namespace convert__std_msgs__msg__byte {

using Ros2_Msg = std_msgs::msg::Byte;
const std::string g_msg_name = "std_msgs/Byte";
...
inline const eprosima::xtypes::StructType& type()
{
    ...
    if (!context.success)
    {
        throw std::runtime_error("Failed while parsing type std_msgs::msg::Byte");
    }
    static eprosima::xtypes::StructType type(context.module().structure("std_msgs::msg::Byte"));
...
namespace utils {
template<>
struct Convert<sh::ros2::convert__std_msgs__msg__byte::Ros2_Msg>
    : MessageConvert<
     sh::ros2::convert__std_msgs__msg__byte::Ros2_Msg,
    &sh::ros2::convert__std_msgs__msg__byte::convert_to_ros2,
    &sh::ros2::convert__std_msgs__msg__byte::convert_to_xtype
    > { };
...
#endif // _IS_SH_ROS2_ROSIDL__ROS2__STD_MSGS__MSG__CONVERT__MSG__BYTE_HPP_
