...
#ifndef _IS_SH_ROS2_ROSIDL__ROS2__STD_MSGS__MSG__CONVERT__MSG__U_INT32_HPP_
#define _IS_SH_ROS2_ROSIDL__ROS2__STD_MSGS__MSG__CONVERT__MSG__U_INT32_HPP_
...
namespace sh {
namespace ros2 {
namespace convert__std_msgs__msg__u_int32 {

using Ros2_Msg = std_msgs::msg::UInt32;
const std::string g_msg_name = "std_msgs/UInt32";
...
inline const eprosima::xtypes::StructType& type()
{
    ...
    if (!context.success)
    {
        throw std::runtime_error("Failed while parsing type std_msgs::msg::UInt32");
    }
    static eprosima::xtypes::StructType type(context.module().structure("std_msgs::msg::UInt32"));
...
namespace utils {
template<>
struct Convert<sh::ros2::convert__std_msgs__msg__u_int32::Ros2_Msg>
    : MessageConvert<
     sh::ros2::convert__std_msgs__msg__u_int32::Ros2_Msg,
    &sh::ros2::convert__std_msgs__msg__u_int32::convert_to_ros2,
    &sh::ros2::convert__std_msgs__msg__u_int32::convert_to_xtype
    > { };
...
#endif // _IS_SH_ROS2_ROSIDL__ROS2__STD_MSGS__MSG__CONVERT__MSG__U_INT32_HPP_
