...
#ifndef _IS_SH_ROS2_ROSIDL__ROS2__STD_MSGS__MSG__CONVERT__MSG__INT8_HPP_
#define _IS_SH_ROS2_ROSIDL__ROS2__STD_MSGS__MSG__CONVERT__MSG__INT8_HPP_
...
namespace sh {
namespace ros2 {
namespace convert__std_msgs__msg__int8 {

using Ros2_Msg = std_msgs::msg::Int8;
const std::string g_msg_name = "std_msgs/Int8";
...
inline const eprosima::xtypes::StructType& type()
{
    ...
    if (!context.success)
    {
        throw std::runtime_error("Failed while parsing type std_msgs::msg::Int8");
    }
    static eprosima::xtypes::StructType type(context.module().structure("std_msgs::msg::Int8"));
...
namespace utils {
template<>
struct Convert<sh::ros2::convert__std_msgs__msg__int8::Ros2_Msg>
    : MessageConvert<
     sh::ros2::convert__std_msgs__msg__int8::Ros2_Msg,
    &sh::ros2::convert__std_msgs__msg__int8::convert_to_ros2,
    &sh::ros2::convert__std_msgs__msg__int8::convert_to_xtype
    > { };
...
#endif // _IS_SH_ROS2_ROSIDL__ROS2__STD_MSGS__MSG__CONVERT__MSG__INT8_HPP_
