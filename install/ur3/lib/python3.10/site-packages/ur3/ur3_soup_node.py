...
class UR3SoupNode(Node):
    ...
    def execute_soup_task(self):
        ...
        ur_script = (
            ...
            + "movel(p[-0.078, 0.248, 0.102, 3.119, 0.207, 0.027], a=1, v=1.5)" + "\n"
            + "sleep(2.)" + "\n"
            ...
            + "movel(p[0.339, -0.081, 0.072, 1.226, -1.272, 1.186], a=1, v=0.1)" + "\n"
        ...
        if self.current_order == 2:
            ur_script += (
                ...
                + "sleep(2.)" + "\n"
                "movel(p[0.339, -0.250, 0.072, 1.211, -1.257, 1.196], a=1, v=0.1)" + "\n"
                + "sleep(1.)" + "\n"
